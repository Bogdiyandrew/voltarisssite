      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mb-24">
          <div className="flex items-center gap-4 mb-8 border-b border-zinc-200 dark:border-zinc-800 pb-4">
            ...
            <h2 className="text-3xl font-bold text-zinc-900 dark:text-white">Producție Tablouri Electrice (Panel Builder)</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800">
              <h3 className="text-xl font-bold mb-3 dark:text-white">Tablouri Automatizare (BMS)</h3>
            ...
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800">
              <h3 className="text-xl font-bold mb-3 dark:text-white">Distribuție Generală</h3>
              <p className="text-zinc-600 dark:text-zinc-400">
                Tablouri generale de distribuție (TGD) de până la 630A, echipate cu aparataj Schneider/Eaton/Legrand.
              </p>
            </div>
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800">
              <h3 className="text-xl font-bold mb-3 dark:text-white">Tablouri Fotovoltaice</h3>
              <p className="text-zinc-600 dark:text-zinc-400">
        ...
        <div className="mb-24">
          <div className="flex items-center gap-4 mb-8 border-b border-zinc-200 dark:border-zinc-800 pb-4">
            ...
            <h2 className="text-3xl font-bold text-zinc-900 dark:text-white">Instalații Electrice (Argeș)</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
             <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3 text-zinc-700 dark:text-zinc-300 p-4 bg-white dark:bg-zinc-900 rounded-lg border border-zinc-100 dark:border-zinc-800">
